...
/// @author Your Name
/// @notice Contract for vesting tokens to a team over a period of time  
contract TeamVesting is Ownable{
    using SafeERC20 for IERC20;  

    IERC20 public token;
    /// @notice Total number of tokens allocated for vesting
    uint256 public constant TOTAL_TOKENS = 66666666 * 1e18; 
    
    /// @notice Duration of the vesting period in days
    uint256 public constant VESTING_DURATION = 48 * 30 days;
    ...
    constructor(address _tokenAddress, address _teamWallet,  address _owner) Ownable(_owner)  {
    ...
    function withdrawVestedTokens() external onlyOwner {
        ...
        vestedTokens = currentBalance >= vestedTokens ? vestedTokens : currentBalance;
